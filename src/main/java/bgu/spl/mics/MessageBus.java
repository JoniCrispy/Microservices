...
public abstract class MessageBus {
     ...
     */
    public abstract <T> void subscribeEvent(Class<? extends Event<T>> type, MicroService m);
     ...
     * @param m    	The subscribing micro-service.
     */
    public abstract void subscribeBroadcast(Class<? extends Broadcast> type, MicroService m);
     ...
     */
    public abstract <T> void complete(Event<T> e, T result);
     ...
     */
    public abstract void sendBroadcast(Broadcast b);
     ...
     */
    public abstract <T> Future<T> sendEvent(Event<T> e);
     ...
     */
    public abstract void register(MicroService m);
     ...
     */
    public abstract void unregister(MicroService m);
     ...
     *                              to became available.
     */
    public abstract Message awaitMessage(MicroService m) throws InterruptedException;
