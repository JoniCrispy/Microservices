...
public abstract class MicroService implements Runnable {
    ...
    private MessageBusImpl messageBus = MessageBusImpl.getMessageBusImlInstance();
    private boolean terminated = false;
    private final String name;
    protected ConcurrentHashMap <Class<? extends Message>,Callback> callbacks = new ConcurrentHashMap<>();
